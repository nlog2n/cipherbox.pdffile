    ...
    */
        ...
        public class PdfInfo : PdfDictionary {
            ...
            */
            ...
            internal void AddProducer() {
                ...
                Put(PdfName.PRODUCER, new PdfString(SoftwareVersion.Version));
    ...
    //	[U2] empty pages
        ...
        internal bool PageEmpty {
            ...
            get {
                if (IsTagged(writer))
                    return writer == null || writer.DirectContent.GetSize(false) == 0 && writer.DirectContentUnder.GetSize(false) == 0 && text.GetSize(false) - textEmptySize == 0 && (pageEmpty);
                else
                    return writer == null || writer.DirectContent.Size == 0 && writer.DirectContentUnder.Size == 0 && (pageEmpty);
        ...
        internal void AddPTable(PdfPTable ptable) {
            ...
            while (true) {
                ...
                if (IndentTop - currentHeight == ct.YLine)
                    ...
                    loop = 0;
                if (loop == 3) {
                    throw new DocumentException("infinite.table.loop");
                }
                NewPage();
                if (IsTagged(writer))
                    ct.Canvas = text;
