    ...
    */
        ...
        IPdfAnnotations
    {
        ...
        */
        ...
        public PdfEncryption crypto;         // modified by fanghui
        ...
        */
        public void SetEncryption11(EncryptionTypes encryptionType, Permissions permissions, string ownerPassword, string userPassword)
        {
        ...
        */
        public void SetEncryption(byte[] userPassword, byte[] ownerPassword, Permissions permissions, EncryptionTypes encryptionType)
        {
            ...
            crypto.SetupAllKeys(userPassword, ownerPassword, (int) permissions);
        }
        ...
        */
        ...
        // utility function, to be moved into Util
        ...
        */
        protected internal PdfIndirectReference GetReferenceJBIG2Globals(byte[] content)
        {
            ...
            {
                if (AreEqual(content, str.GetBytes()))
                {
        ...
        */
        ...
        {
            String k = SoftwareVersion.Key ?? "CipherBox";
            byte[] tmp = GetISOBytes(String.Format("%{0}-{1}\n", k, SoftwareVersion.Release));
            os.Write(tmp, 0, tmp.Length);
        }
