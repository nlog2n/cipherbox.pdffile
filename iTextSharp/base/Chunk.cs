...
/*
 * $Id: Chunk.cs 551 2013-06-03 10:01:29Z pavel-alay $
 * 
 *
    ...
    /** This is a Chunk containing a newpage. */
        ...
        */
        ...
        public Chunk(IDrawInterface separator, float tabPosition, bool newline) : this(OBJECT_REPLACEMENT_CHARACTER, new Font()) {
            if (tabPosition < 0) {
                throw new ArgumentException("a.tab.position.may.not.be.lower.than.0.yours.is " + tabPosition.ToString());
            }
        ...
        {
            if (tabInterval < 0)
                throw new ArgumentException("a.tab.position.may.not.be.lower.than.0.yours.is "+ tabInterval.ToString());
