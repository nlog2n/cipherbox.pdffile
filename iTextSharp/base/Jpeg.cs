        ...
        private void ProcessParameters() {
            ...
            try {
                ...
                if (istr.ReadByte() != 0xFF || istr.ReadByte() != 0xD8)    {
                    throw new DocumentException("BadElement: " + errorID + " is.not.a.valid.jpeg.file");
                }
                bool firstPass = true;
                int len;
                while (true) {
                    ...
                    if (v == 0xFF) {
                        ...
                        if (firstPass && marker == M_APP0) {
                            ...
                            if (r != bcomp.Length)
                                throw new DocumentException("BadElement: " + "corrupted.jfif.marker: " + errorID);
                            bool found = true;
                        ...
                        if (markertype == VALID_MARKER) {
                            ...
                            if (istr.ReadByte() != 0x08) {
                                throw new DocumentException("BadElement: " + errorID + " must.have.8.bits.per.component");
                            }
                            ...
                            throw new DocumentException("BadElement: " + errorID + " unsupported.jpeg.marker "+ marker);
                        }
