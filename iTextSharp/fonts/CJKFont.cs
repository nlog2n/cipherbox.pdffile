...
namespace iTextSharp.text.pdf
{
    ...
    internal class CJKFont : BaseFont
    {
        ...
        internal CJKFont(string fontName, string enc, bool emb)
        {
            ...
            {
                throw new DocumentException(string.Format("font {0} with {1} encoding is not a cjk font", fontName, enc));
            }
        ...
        internal String UniMap { get { return uniMap; } }
        ...
        private void LoadCMaps()
        {
            ...
            {
                Console.WriteLine(ex.Message + " " + fontName);
        ...
        public static String GetCompatibleFont(String enc)
        {
            ...
            {
                if ( e.Value != null && e.Value.ContainsKey("Registry") ) // added by fanghui, for missing chinese fonts
        ...
        internal static Dictionary<String, Object> ReadFontProperties(String name)
        {
            try
            {
                ...
                if (isp == null)
                {
                    Console.WriteLine("Pdf read font error - " + name);
                    return null;
                }
            ...
            catch (Exception)  // added by fanghui
            {
                Console.WriteLine("Pdf read font error - " + name);
                return null;
            }
